  ...
  <div className="ruby-menu-demo-header">
    ...
    <div className="ruby-wrapper">
      ...
      <ul className="ruby-menu">
            ...
            <div className="ruby-row">
              ...
              <div className="ruby-col-3 ruby-col-4-md">
                ...
                <ul className="ruby-list-with-images">
                  <li>
                    ...
                    <span className="ruby-list-desc">Lorem ipsum dolor sit</span>
                  </li>
                  <li>
                    <a href="#">
                      <img src="img/c-2.png" />
              ...
              <div className="ruby-col-5">
                ...
                <div className="ruby-row">
                  ...
                  <div
                    className="ruby-col-4 ruby-col-6-md"
                  ...
                  <div
                    className="ruby-col-4 hidden-md"
                  ...
                  >
                    <ul>
                      ...
                      <li>
                        <a href="#">
                          <i className="fa fa-legal" aria-hidden="true" />
                          Menu Item
                        </a>
                      </li>
                      <li>
            ...
            <ul className="ruby-menu-mega-blog-nav">
                  ...
                  <div className="ruby-row">
                    <div className="ruby-col-3">
                      ...
                      <span className="ruby-c-title ruby-margin-10">
                        <a href="#">Vacation Proved To Increase Productivity</a>
                      </span>
                      <span className="ruby-c-content">
                        The primary research for the study was based on an online
                        survey that was...
                      </span>
                    </div>
                    <div className="ruby-col-3">
                      ...
                      <span className="ruby-c-title ruby-margin-10">
                        <a href="#">Stereotype Idioms By The Smokers</a>
                      </span>
                      <span className="ruby-c-content">
                        If you have ever said some of below idioms you are for
                        sure a smoking...
                      </span>
                    </div>
                    <div className="ruby-col-3">
                      ...
                      <span className="ruby-c-title ruby-margin-10">
                        <a href="#">10 Facts About The Philosophers</a>
                      </span>
                      <span className="ruby-c-content">
                        When we think “philosopher,” a certain image comes to
                        mind—most often a wise...
                      </span>
                    </div>
                    <div className="ruby-col-3">
                      ...
                      <span className="ruby-c-title ruby-margin-10">
                        <a href="#">
                          In 2016, 10 People Died While Taking Selfie
                        </a>
                      </span>
                      <span className="ruby-c-content">
                        This is a list of serious injuries and deaths in which the
                        victim or a member of...
                      </span>
                    </div>
                  </div>
                </div>
                ...
                >
                  <div className="ruby-row">
                    <div className="ruby-col-4">
                      ...
                      <div className="ruby-col-7">
                        <span className="ruby-c-title">
                          <a href="#">An Erupting Volcano And A Meteor</a>
                        </span>
                        <span className="ruby-c-category">
                    ...
                    <div className="ruby-col-4">
                      ...
                      <div className="ruby-col-7">
                        <span className="ruby-c-title">
                          <a href="#">Bottle Labels: Short Stories To Read</a>
                        </span>
                        <span className="ruby-c-category">
                          <a href="#">News / Culture</a>
                        </span>
                    ...
                    <div className="ruby-col-4">
                      ...
                      <div className="ruby-col-7">
                        <span className="ruby-c-title">
                          <a href="#">
                            10+ Stunning Animal Portraits By Polyushko
                          </a>
                        </span>
                        <span className="ruby-c-category">
                          <a href="#">News / Photography</a>
                        </span>
                        <span className="ruby-c-date">
                          <a href="#">05/01/2017</a>
                        </span>
                  ...
                  <div className="ruby-row">
                    <div className="ruby-col-4">
                      ...
                      <div className="ruby-col-7">
                        <span className="ruby-c-title">
                          <a href="#">Photographing The Beauty Of Fall</a>
                        </span>
                        <span className="ruby-c-category">
                          <a href="#">News / Photography</a>
                        </span>
                    ...
                    <div className="ruby-col-4">
                      ...
                      <div className="ruby-col-7">
                        <span className="ruby-c-title">
                          <a href="#">10 Freaking Facts About Being A Pilot</a>
                        </span>
                        <span className="ruby-c-category">
                          <a href="#">News / Life</a>
                        </span>
                    ...
                    <div className="ruby-col-4">
                      ...
                      <div className="ruby-col-7">
                        <span className="ruby-c-title">
                          <a href="#">Health Benefits Of A Glass Of Whiskey</a>
                        </span>
                        <span className="ruby-c-category">
                          <a href="#">News / Health</a>
                        </span>
                  ...
                  <div className="ruby-row">
                    <div className="ruby-col-6">
                      ...
                      <div className="ruby-col-8">
                        <span className="ruby-c-title">
                          <a href="#">
                            Nexo Created New Airless Bike Tires That Will Never
                            Get Flat
                          </a>
                        </span>
                        <div className="ruby-c-inline">
                          <span className="ruby-c-category">
                            <a href="#">
                              <i className="fa fa-tag" aria-hidden="true" /> News
                              / Tech
                            </a>
                          </span>
                          <span className="ruby-c-date">
                    ...
                    <div className="ruby-col-6">
                      ...
                      <div className="ruby-col-8">
                        <span className="ruby-c-title">
                          <a href="#">
                            Illustrator Creates Stunning Dresses From Everyday
                            Objects
                          </a>
                        </span>
                        <div className="ruby-c-inline">
                  ...
                  <div className="ruby-row">
                    <div className="ruby-col-6">
                      ...
                      <div className="ruby-col-8">
                        <span className="ruby-c-title">
                          <a href="#">
                            Italian Pastry Chef Creates Miniature Worlds With
                            Desserts
                          </a>
                        </span>
                        <div className="ruby-c-inline">
                    ...
                    <div className="ruby-col-6">
                      ...
                      <div className="ruby-col-8">
                        <span className="ruby-c-title">
                          <a href="#">
                            Dogs Brought To The Lavender Gardens To Capture Their
                            Joy
                          </a>
                        </span>
                        <div className="ruby-c-inline">
              ...
              <li>
                ...
                >
                  <div className="ruby-row">
                    <div className="ruby-col-6">
                      <span className="ruby-c-title" style={{ marginBottom: 15 }}>
                        POPULAR THREADS
                      </span>
                      <div className="ruby-row">
                        <div className="ruby-col-1">
                          <img src="img/blog-1.jpg" />
                        </div>
                        <div className="ruby-col-11">
                          <span className="ruby-c-title">
                            <a href="#">
                      ...
                      <div className="ruby-row">
                        ...
                        <div className="ruby-col-11">
                          <span className="ruby-c-title">
                            <a href="#">
                              Bottle Labels With Short Stories To Be Read Is The
                              New Marketing Era
                            </a>
                          </span>
                        </div>
                      ...
                      <div className="ruby-row">
                        ...
                        <div className="ruby-col-11">
                          <span className="ruby-c-title">
                            <a href="#">
                              10+ Stunning Animal Portraits That Has Been Filmed
                              By Polyushko
                            </a>
                          </span>
                        </div>
                      ...
                      <div className="ruby-row">
                        ...
                        <div className="ruby-col-11">
                          <span className="ruby-c-title">
                            <a href="#">
                              10 Freaking Facts About Being An airline pilot
                            </a>
                          </span>
                        </div>
                      </div>
        ...
        <li className="ruby-menu-mega-shop">
          <a href="#">Shop</a>
                ...
                <div className="ruby-grid ruby-grid-lined">
                  <div className="ruby-row">
                    <div className="ruby-col-3">
                      ...
                      <h3 className="ruby-list-heading" style={{ marginTop: 16 }}>
                        EYEWEAR
                      </h3>
                      <ul>
                        <li>
