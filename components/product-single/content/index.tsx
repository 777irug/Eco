...
import productsDimensions from '../../../utils/data/products-Dimensions';
...
const Content = ({ product }: ProductContent) => {
  ...
  const onSelectChange = (e: React.ChangeEvent<HTMLSelectElement>) => setItemDimensions(e.target.value);
  ...
  return (
    <section className="product-content">
      ...
      <div className="product-content__filters">
        ...
        <div className="product-filter-item">
          <h5>Dimensions: <strong>See Dimensions table</strong></h5>
          <div className="checkbox-color-wrapper">
            <div className="select-wrapper">
              <select onChange={onSelectChange}>
                <option>Choose Dimensions</option>
                {productsDimensions.map(type => (
